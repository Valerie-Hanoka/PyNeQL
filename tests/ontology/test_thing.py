...
#    assert thing.has_label == expected.get('has_label')
#    assert thing.query_language == expected.get('query_language')
#    assert reduce((lambda x, y: x or y), ['Paris' in attr for attr in thing.attributes.get(u'owl:sameAs')])
#
#
...
#    thing = Thing(url=['http://data.bnf.fr/ark:/12148/cb118905823#about', 'http://dbpedia.org/resource/Charles_Baudelaire'])
#    thing.add_query_endpoints([Endpoint.bnf])
#    thing.query(strict_mode=True)
#    assert u'http://data.bnf.fr/ark:/12148/cb118905823#about' in thing.attributes.get(u'owl:sameAs')
#
